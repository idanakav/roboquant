...
/**
 * Apply Vector Trigonometric ACos on the provided input data and return the output result. If there is insufficient
...
/**
 * Apply Chaikin A/D Line on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Vector Arithmetic Add on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Chaikin A/D Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Volume Indicators.
 */
fun adOsc(high : DoubleArray,low : DoubleArray,close : DoubleArray,volume : DoubleArray, fastPeriod:Int = 3,slowPeriod:Int = 10,):  DoubleArray {
    val endIdx = high.lastIndex
    val outputSize = high.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.adOsc(0, endIdx, high,low,close,volume, fastPeriod,slowPeriod, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Average Directional Movement Index on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Average Directional Movement Index Rating on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Absolute Price Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
fun apo(data : DoubleArray, fastPeriod:Int = 12,slowPeriod:Int = 26,mAType:MAType = MAType.Ema,):  DoubleArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Aroon on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
...
/**
 * Apply Aroon Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Vector Trigonometric ASin on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Trigonometric ATan on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Average True Range on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Average Price on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
fun avgPrice(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, ):  DoubleArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Bollinger Bands on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Overlap Studies.
         */
        fun bbands(data : DoubleArray, timePeriod:Int = 5,deviationsup:Double =  2.000000e+0,deviationsdown:Double =  2.000000e+0,mAType:MAType = MAType.Ema,):  Triple<DoubleArray, DoubleArray, DoubleArray> {
            val endIdx = data.lastIndex
            val outputSize = data.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
val output3 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.bbands(0, endIdx, data, timePeriod,deviationsup,deviationsdown,mAType, startOutput, endOutput, output1,output2,output3)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
...
/**
 * Apply Beta on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Balance Of Power on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Commodity Channel Index on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Two Crows on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Three Black Crows on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Three Inside Up/Down on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Three-Line Strike on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Three Outside Up/Down on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Three Stars In The South on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Three Advancing White Soldiers on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Abandoned Baby on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlAbandonedBaby(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  3.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply Advance Block on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Belt-hold on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Breakaway on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Closing Marubozu on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Concealing Baby Swallow on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Counterattack on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Dark Cloud Cover on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlDarkCloudCover(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  5.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.cdlDarkCloudCover(0, endIdx, open,high,low,close, penetration, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Doji on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Doji Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Dragonfly Doji on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Engulfing Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Evening Doji Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlEveningDojiStar(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  3.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.cdlEveningDojiStar(0, endIdx, open,high,low,close, penetration, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Evening Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlEveningStar(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  3.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply Up/Down-gap side-by-side white lines on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Gravestone Doji on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Hammer on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Hanging Man on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Harami Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Harami Cross Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply High-Wave Candle on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Hikkake Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Modified Hikkake Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Homing Pigeon on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Identical Three Crows on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply In-Neck Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Inverted Hammer on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Kicking on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Kicking - bull/bear determined by the longer marubozu on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Ladder Bottom on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Long Legged Doji on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Long Line Candle on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Marubozu on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Matching Low on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Mat Hold on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlMatHold(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  5.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply Morning Doji Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlMorningDojiStar(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  3.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.cdlMorningDojiStar(0, endIdx, open,high,low,close, penetration, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Morning Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlMorningStar(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, penetration:Double =  3.000000e-1,):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply On-Neck Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Piercing Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Rickshaw Man on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Rising/Falling Three Methods on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Separating Lines on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Shooting Star on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Short Line Candle on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Spinning Top on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Stalled Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Stick Sandwich on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
fun cdlStickSandwich(open : DoubleArray,high : DoubleArray,low : DoubleArray,close : DoubleArray, ):  IntArray {
    val endIdx = open.lastIndex
    val outputSize = open.size
    val output1 = IntArray(outputSize)
    val startOutput = MInteger()
    ...
    val last = endOutput.value
     if (last < 0) {
        ...
        throw InsufficientData("Not enough data to calculate cdlStickSandwich, required lookback period is $lookback")
    }
    return output1.copyOfRange(0, last)
}    
/**
 * Apply Takuri (Dragonfly Doji with very long lower shadow) on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Tasuki Gap on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Thrusting Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Tristar Pattern on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Unique 3 River on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Upside Gap Two Crows on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Upside/Downside Gap Three Methods on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Pattern Recognition.
 */
...
/**
 * Apply Vector Ceil on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Chande Momentum Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Pearson's Correlation Coefficient (r) on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Vector Trigonometric Cos on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Trigonometric Cosh on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Double Exponential Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Vector Arithmetic Div on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Directional Movement Index on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Exponential Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Vector Arithmetic Exp on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Floor on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Hilbert Transform - Dominant Cycle Period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
...
/**
 * Apply Hilbert Transform - Dominant Cycle Phase on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Cycle Indicators.
 */
fun htDcPhase(data : DoubleArray, ):  DoubleArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Hilbert Transform - Phasor Components on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Cycle Indicators.
         */
...
val output2 = DoubleArray(outputSize)
        ...
        /**
         * Apply Hilbert Transform - SineWave on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Cycle Indicators.
         */
...
/**
 * Apply Hilbert Transform - Instantaneous Trendline on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Hilbert Transform - Trend vs Cycle Mode on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Cycle Indicators.
 */
...
/**
 * Apply Kaufman Adaptive Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Linear Regression on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Linear Regression Angle on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Linear Regression Intercept on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Linear Regression Slope on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Vector Log Natural on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Log10 on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Moving average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
fun movingAverage(data : DoubleArray, timePeriod:Int = 30,mAType:MAType = MAType.Ema,):  DoubleArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Moving Average Convergence/Divergence on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
        fun macd(data : DoubleArray, fastPeriod:Int = 12,slowPeriod:Int = 26,signalPeriod:Int = 9,):  Triple<DoubleArray, DoubleArray, DoubleArray> {
            val endIdx = data.lastIndex
            val outputSize = data.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
val output3 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.macd(0, endIdx, data, fastPeriod,slowPeriod,signalPeriod, startOutput, endOutput, output1,output2,output3)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
        ...
        /**
         * Apply MACD with controllable MA type on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
        fun macdExt(data : DoubleArray, fastPeriod:Int = 12,fastMA:MAType = MAType.Ema,slowPeriod:Int = 26,slowMA:MAType = MAType.Ema,signalPeriod:Int = 9,signalMA:MAType = MAType.Ema,):  Triple<DoubleArray, DoubleArray, DoubleArray> {
            val endIdx = data.lastIndex
            val outputSize = data.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
val output3 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.macdExt(0, endIdx, data, fastPeriod,fastMA,slowPeriod,slowMA,signalPeriod,signalMA, startOutput, endOutput, output1,output2,output3)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
        ...
        /**
         * Apply Moving Average Convergence/Divergence Fix 12/26 on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
...
val output3 = DoubleArray(outputSize)
        ...
        /**
         * Apply MESA Adaptive Moving Average on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Overlap Studies.
         */
        fun mama(data : DoubleArray, fastLimit:Double =  5.000000e-1,slowLimit:Double =  5.000000e-2,):  Pair<DoubleArray, DoubleArray> {
            val endIdx = data.lastIndex
            val outputSize = data.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
...
/**
 * Apply Moving average with variable period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
fun movingAverageVariablePeriod(data : DoubleArray,inPeriods : DoubleArray, minimumPeriod:Int = 2,maximumPeriod:Int = 30,mAType:MAType = MAType.Ema,):  DoubleArray {
    val endIdx = data.lastIndex
    val outputSize = data.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.movingAverageVariablePeriod(0, endIdx, data,inPeriods, minimumPeriod,maximumPeriod,mAType, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Highest value over a specified period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Index of highest value over a specified period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Median Price on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Price Transform.
 */
...
/**
 * Apply Money Flow Index on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
fun mfi(high : DoubleArray,low : DoubleArray,close : DoubleArray,volume : DoubleArray, timePeriod:Int = 14,):  DoubleArray {
    val endIdx = high.lastIndex
    val outputSize = high.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply MidPoint over period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Midpoint Price over period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Lowest value over a specified period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Index of lowest value over a specified period on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
fun minIndex(data : DoubleArray, timePeriod:Int = 30,):  IntArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Lowest and highest values over a specified period on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Math Operators.
         */
...
val output2 = DoubleArray(outputSize)
        ...
        /**
         * Apply Indexes of lowest and highest values over a specified period on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Math Operators.
         */
...
/**
 * Apply Minus Directional Indicator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Minus Directional Movement on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Momentum on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Vector Arithmetic Mult on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Normalized Average True Range on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Volatility Indicators.
 */
...
/**
 * Apply On Balance Volume on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Volume Indicators.
 */
...
/**
 * Apply Plus Directional Indicator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Plus Directional Movement on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Percentage Price Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Rate of change : ((price/prevPrice)-1) * 100 on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Rate of change Percentage: (price-prevPrice)/prevPrice on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Rate of change ratio: (price/prevPrice) on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Rate of change ratio 100 scale: (price/prevPrice) * 100 on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Relative Strength Index on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Parabolic SAR on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
fun sar(high : DoubleArray,low : DoubleArray, accelerationFactor:Double =  2.000000e-2,aFMaximum:Double =  2.000000e-1,):  DoubleArray {
    val endIdx = high.lastIndex
    val outputSize = high.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
...
/**
 * Apply Parabolic SAR - Extended on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
fun sarExt(high : DoubleArray,low : DoubleArray, startValue:Double =  0.000000e+0,offsetonReverse:Double =  0.000000e+0,aFInitLong:Double =  2.000000e-2,aFLong:Double =  2.000000e-2,aFMaxLong:Double =  2.000000e-1,aFInitShort:Double =  2.000000e-2,aFShort:Double =  2.000000e-2,aFMaxShort:Double =  2.000000e-1,):  DoubleArray {
    val endIdx = high.lastIndex
    val outputSize = high.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.sarExt(0, endIdx, high,low, startValue,offsetonReverse,aFInitLong,aFLong,aFMaxLong,aFInitShort,aFShort,aFMaxShort, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
        val lookback = core.sarExtLookback(startValue,offsetonReverse,aFInitLong,aFLong,aFMaxLong,aFInitShort,aFShort,aFMaxShort,)
        throw InsufficientData("Not enough data to calculate sarExt, required lookback period is $lookback")
    }
    return output1.copyOfRange(0, last)
}    
/**
 * Apply Vector Trigonometric Sin on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Trigonometric Sinh on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Simple Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Vector Square Root on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Standard Deviation on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
fun stdDev(data : DoubleArray, timePeriod:Int = 5,deviations:Double =  1.000000e+0,):  DoubleArray {
    ...
    return output1.copyOfRange(0, last)
        ...
        /**
         * Apply Stochastic on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
        fun stoch(high : DoubleArray,low : DoubleArray,close : DoubleArray, fastKPeriod:Int = 5,slowKPeriod:Int = 3,slowKMA:MAType = MAType.Ema,slowDPeriod:Int = 3,slowDMA:MAType = MAType.Ema,):  Pair<DoubleArray, DoubleArray> {
            val endIdx = high.lastIndex
            val outputSize = high.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.stoch(0, endIdx, high,low,close, fastKPeriod,slowKPeriod,slowKMA,slowDPeriod,slowDMA, startOutput, endOutput, output1,output2)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
        ...
        /**
         * Apply Stochastic Fast on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
        fun stochF(high : DoubleArray,low : DoubleArray,close : DoubleArray, fastKPeriod:Int = 5,fastDPeriod:Int = 3,fastDMA:MAType = MAType.Ema,):  Pair<DoubleArray, DoubleArray> {
            val endIdx = high.lastIndex
            val outputSize = high.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.stochF(0, endIdx, high,low,close, fastKPeriod,fastDPeriod,fastDMA, startOutput, endOutput, output1,output2)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
        ...
        /**
         * Apply Stochastic Relative Strength Index on the provided input data and return the output result. If there is insufficient
         * data to calculate the indicators, an [InsufficientData] will be thrown.
         * This indicator belongs to the group Momentum Indicators.
         */
        fun stochRsi(data : DoubleArray, timePeriod:Int = 14,fastKPeriod:Int = 5,fastDPeriod:Int = 3,fastDMA:MAType = MAType.Ema,):  Pair<DoubleArray, DoubleArray> {
            val endIdx = data.lastIndex
            val outputSize = data.size
            val output1 = DoubleArray(outputSize)
val output2 = DoubleArray(outputSize)
            val startOutput = MInteger()
            val endOutput = MInteger()
            val ret = core.stochRsi(0, endIdx, data, timePeriod,fastKPeriod,fastDPeriod,fastDMA, startOutput, endOutput, output1,output2)
            if (ret != RetCode.Success) throw Exception(ret.toString())
            val last = endOutput.value
             if (last < 0) {
...
/**
 * Apply Vector Arithmetic Subtraction on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Summation on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Operators.
 */
...
/**
 * Apply Triple Exponential Moving Average (T3) on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply Vector Trigonometric Tan on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Vector Trigonometric Tanh on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Math Transform.
 */
...
/**
 * Apply Triple Exponential Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply True Range on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Volatility Indicators.
 */
...
/**
 * Apply Triangular Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
...
/**
 * Apply 1-day Rate-Of-Change (ROC) of a Triple Smooth EMA on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Time Series Forecast on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Typical Price on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Price Transform.
 */
...
/**
 * Apply Ultimate Oscillator on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
fun ultOsc(high : DoubleArray,low : DoubleArray,close : DoubleArray, firstPeriod:Int = 7,secondPeriod:Int = 14,thirdPeriod:Int = 28,):  DoubleArray {
    val endIdx = high.lastIndex
    val outputSize = high.size
    val output1 = DoubleArray(outputSize)
    val startOutput = MInteger()
    val endOutput = MInteger()
    val ret = core.ultOsc(0, endIdx, high,low,close, firstPeriod,secondPeriod,thirdPeriod, startOutput, endOutput, output1)
    if (ret != RetCode.Success) throw Exception(ret.toString())
    val last = endOutput.value
     if (last < 0) {
...
/**
 * Apply Variance on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Statistic Functions.
 */
...
/**
 * Apply Weighted Close Price on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Price Transform.
 */
...
/**
 * Apply Williams' %R on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Momentum Indicators.
 */
...
/**
 * Apply Weighted Moving Average on the provided input data and return the output result. If there is insufficient
 * data to calculate the indicators, an [InsufficientData] will be thrown.
 * This indicator belongs to the group Overlap Studies.
 */
