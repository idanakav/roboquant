            ...
            buildList<Any> {
                ...
                indicators.forEach {
                    ...
                    if(index < offset) {
                        ...
                        add(it.values[index - offset].round())
                    }
                }
            }
        }
    ...
    override fun renderCustomData(): String {
        ...
        val tradeRows = {
            trades.joinToString(separator = "\n") {
                ...
                val time = it.time.atZone(Config.defaultZoneId).format(DateTimeFormatter.ofLocalizedDateTime(
                    FormatStyle.MEDIUM))
                val price = it.price.round()
                val quantity = it.size
